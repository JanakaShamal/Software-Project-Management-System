...
$contact_number= $current_user->get_contact_number();
 ?>
				...
				<div class="inner">
					...
					<form method="post" action="#">
						...
						<div class="field half">
							...
							<input type="text" name="lastemail" id="lastname" value="<?php echo $lastname ?>" />
						</div>
						<div class="field">
						...
						<div class="field">
							...
							<input type="Password" name="password" id="password" value="Type New Password" />
						</div>
						<div class="field">
